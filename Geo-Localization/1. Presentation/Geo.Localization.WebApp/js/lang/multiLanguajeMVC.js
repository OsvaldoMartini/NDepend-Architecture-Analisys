var MultiLanguageMVC = MultiLanguageMVC || {};

MultiLanguageMVC.createNameSpace = function (namespace) {
    //get the namespace string and split it
    var namespaceArr = namespace.split('.');
    var parent = MultiLanguageMVC;

    // excluding the parent
    if (namespaceArr[0] === 'MultiLanguageMVC') {
...
MultiLanguageMVC.createNameSpace("MultiLanguageMVC.Cookies");

MultiLanguageMVC.Cookies.getCookie = function (ck_name) {
...
MultiLanguageMVC.Cookies.setCookie = function (ck_name, value, exdays) {
    var exdate = new Date();
